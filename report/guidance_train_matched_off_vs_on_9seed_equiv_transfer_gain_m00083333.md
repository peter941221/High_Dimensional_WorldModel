# Equivalence-Oriented Report: guidance_train_matched_off_vs_on_9seed_equiv_transfer_gain_m00083333
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `transfer_gain_mean` | 9 | -0.001852 | -0.006481 | 0.002315 | 0.006481 | `true` |
